  ...
  @forelse($productos as $producto)
    ...
    <div class="col-12 col-md-6">
      <div class="card card-custom p-3 producto-card">
        ...
        @if($producto->imagen)
          <img src="{{ asset('storage/' . $producto->imagen) }}" alt="{{ $nombreProd }}" class="rounded mb-2" style="max-height:180px; max-width:100%; width:auto; object-fit:contain; display:block; margin:0 auto;">        @endif
